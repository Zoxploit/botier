...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6282239042679@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			wait: 'Sabar Lagi Proses Bre...!',
			success: 'Done Jangan Lupa Follow ignya Kenzoxploit_',
			error: {
				stick: 'Gagal Convert Gambar To Sticker...Coba Lagi !',
				Iv: 'Linknya Error Bro !'
			},
			only: {
				admin: 'Kusus Admin kak !',
				group: 'Khusus Group bre !'
			}
		}
		faketeks = 'Zero YT7'
		let isUrl = (url) => {
...
❋────────────────────────❋
📸 Whatsapp
https://wa.me/6282239042679
📰 Instagram
https://instagram.com/kenzoxploit_
📺Tiktok
https://tiktok.com/@kenzoxploit
📌 Github
https://github.com/Zoxploit
❋────────────────────────❋`
but = [
...
button = [
  {buttonId: '.youtube', buttonText: {displayText: '☰ WHATSAPP'}, type: 1},
...
zeroyt7.sendMessage(`6282239042679@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'youtube':
teks =
`Nih Whatsapp Owner Ku Jangan Lupa Di Save Ya https://wa.me/6282239042679`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/kenzoxploit_`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@kenzoxploit`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
